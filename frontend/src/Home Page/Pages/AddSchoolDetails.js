    ...
    <React.Fragment>
      ...
      <div className="AddSchoolDetails">
                ...
                <div className="checkbox-group">
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="Nursery"
                      value="Nursery"
                      checked={formState.inputs.classNumber.value.includes("Nursery")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="LKG_PP1"
                      value="LKG_PP1"
                      checked={formState.inputs.classNumber.value.includes("LKG_PP1")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="UKG_PP2"
                      value="UKG_PP2"
                      checked={formState.inputs.classNumber.value.includes("UKG_PP2")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class1"
                      value="Class_1"
                      checked={formState.inputs.classNumber.value.includes("Class_1")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class2"
                      value="Class_2"
                      checked={formState.inputs.classNumber.value.includes("Class_2")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class3"
                      value="Class_3"
                      checked={formState.inputs.classNumber.value.includes("Class_3")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class4"
                      value="Class_4"
                      checked={formState.inputs.classNumber.value.includes("Class_4")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class5"
                      value="Class_5"
                      checked={formState.inputs.classNumber.value.includes("Class_5")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class6"
                      value="Class_6"
                      checked={formState.inputs.classNumber.value.includes("Class_6")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class7"
                      value="Class_7"
                      checked={formState.inputs.classNumber.value.includes("Class_7")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class8"
                      value="Class_8"
                      checked={formState.inputs.classNumber.value.includes("Class_8")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class9"
                      value="Class_9"
                      checked={formState.inputs.classNumber.value.includes("Class_9")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class10"
                      value="Class_10"
                      checked={formState.inputs.classNumber.value.includes("Class_10")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class11"
                      value="Class_11"
                      checked={formState.inputs.classNumber.value.includes("Class_11")}
                  ...
                  <div className="checkbox-container">
                    <input
                      ...
                      id="class12"
                      value="Class_12"
                      checked={formState.inputs.classNumber.value.includes("Class_12")}
        ...
        <br/>
              ...
              <div className="form-group">
                <Button type="submit" className="submit-btn" disabled={!formState.isValid}>Submit</Button>
              </div>
            </form>
          </div>
        </center>
